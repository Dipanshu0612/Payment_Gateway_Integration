  ...
  return (
    ...
    <div className='bg-neutral-900 h-[20rem] flex justify-around items-center'>
        ...
        <h3 className='text-[1.5rem] text-white px-4 py-4 font-semibold'>Websites</h3>
            ...
            <a href='thesparksfoundation.in/' className=' duration-200  hover:text-white ease-in-out block text-gray-400 px-4 py-2'>The Sparks Foundation (India)</a>
    ...
    © 2023 The Sparks Foundation. All Rights Reserved | Design by <a href="https://www.linkedin.com/in/dipanshu-mishra-696a0622a/"><span className='text-blue-500 text-lg font-bold cursor-pointer hover:text-blue-300 hover:ease-in-out duration-500'>&nbsp;Dipanshu Mishra</span> </a>
    </div>
    </>
  )
}
