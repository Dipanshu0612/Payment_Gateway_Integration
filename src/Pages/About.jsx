  ...
  return (
    <div className='flex flex-wrap bg-slate-200 my-3 flex-col justify-center items-center space-y-5'>
      ...
      <div className="box flex flex-wrap justify-center items-center flex-col my-4">
        ...
        <h4>A world of enabled and connected little minds, building future.</h4>
      </div>
      <div className="box flex flex-wrap justify-center items-center flex-col ">
        ...
        <h4>To inspire students, help them innovate and let them integrate to build the next generation humankind.</h4>
        <div className="missioncont flex justify-around items-center px-[4.5rem] py-3">
      ...
      <div className="box flex flex-wrap justify-center items-center flex-col space-y-5">
        ...
        <div className='flex justify-center items-center px-4 py-2 space-x-10'>
          <div className="valuebox1 px-[4rem] space-y-7">
            <h4>Resilience</h4>
            <h4>Commitment</h4>
            <h4>Integrity</h4>
          </div>
          <div className="valuebox2 px-[4rem] space-y-7">
            <h4>Respect</h4>
            <h4>People</h4>
            <h4>Training</h4>
          </div>
          <div className="valuebox3 px-[4rem] space-y-7">
            <h4>Excellence</h4>
            <h4>Quality</h4>
